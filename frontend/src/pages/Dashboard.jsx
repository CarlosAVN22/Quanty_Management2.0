        ...
        <div className="page-stack">
            ...
            <section className="hero-card">
                <div>
                    ...
                    <p>
                        Diseñado para que veas rápido lo importante al facturar: ventas del día, estado DTE, últimas emisiones,
                        stock sensible y cómo se está cobrando en la caja.
                    </p>
                </div>
                <div className="hero-actions wrap">
                    {usuario?.sucursal_nombre && <div className="pill">Sucursal: {usuario.sucursal_nombre}</div>}
            ...
            <section className="panel dashboard-full-panel">
                <div className="panel-header"><div><h3>Últimas ventas del día</h3><p>Esta tabla ahora ocupa todo el ancho para revisar número de control, cliente, método, estado y hora sin que se vea cortada.</p></div></div>
